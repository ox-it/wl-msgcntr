      ...
      <sakai:tool_bar_message value="#{msgs.cdfm_discussion_forum_settings}" />
		<div class="instruction">
		  ...
		  <h:outputText value="#{msgs.cdfm_info_required_sign}" styleClass="reqStarInline" />
			...
			<sakai:inputRichText textareaOnly="#{ForumTool.textForum}" rows="12" cols="120" id="df_compose_description" value="#{ForumTool.selectedForum.forum.extendedDescription}">
