...
public class ForumTopicEntityProviderImpl implements ForumTopicEntityProvider,
        AutoRegisterEntityProvider, PropertyProvideable, RESTful, ActionsExecutable {
  ...
  private static final Log LOG = LogFactory.getLog(ForumTopicEntityProviderImpl.class);
  ...
  public List<?> getForum(EntityView view, Map<String, Object> params) {
    ...
    if (forumId == null) {
      ...
      if (forumId == null) {
        throw new IllegalArgumentException("forumId must be set in order to get the forum info, set in params or in the URL /forum_topic/forum/forumId");
      }
    }
  ...
  public List<?> getForumsInSite(EntityView view, Map<String, Object> params) {
    ...
    if (siteId == null) {
      ...
      if (siteId == null) {
        throw new IllegalArgumentException("site must be set in order to get the forum info, set in params or in the URL /forum_topic/site/siteId");
      }
    }
    List<?> l = getEntities(new EntityReference(ENTITY_PREFIX, ""),
  ...
  public List<?> getPrivateTopicsInSite(EntityView view, Map<String, Object> params) {
    ...
    if (siteId == null) {
      ...
      if (siteId == null) {
        throw new IllegalArgumentException("siteId must be set in order to get the private topic info, set in params or in the URL /forum_topic/private/siteId");
      }
    }
    List<?> l = getEntities(new EntityReference(ENTITY_PREFIX, ""),
